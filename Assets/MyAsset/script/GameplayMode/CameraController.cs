...
public class CameraController : MonoBehaviour {
	...
	void Update () {
        ...
        else if (EndRewardQuest.isCameraViewToViewOpenedBox == true)
        {
        ...
        else if(EndDistanceQuest.isCameraViewToplayer == true)
        {
            this.transform.position = Vector3.Lerp(this.transform.position,
                GameObject.Find("castlePlatform/CameraPointView").transform.position,1f);
            this.transform.LookAt(playerPosition.position);
        }
        #endregion
