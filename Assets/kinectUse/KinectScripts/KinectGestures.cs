		...
		switch(gestureData.gesture)
		{
			...
			case Gestures.RaiseRightHand:
				switch(gestureData.state)
				{
					case 0:  // gesture detection
                        ...
                        {
                            GameObject.Find("kinectController").GetComponent<MyKinectController>().isMoving = "moveRight";
                            SetGestureJoint(ref gestureData, timestamp, rightHandIndex, jointsPos[rightHandIndex]);
                        }
                        break;
                            
                    case 1:  // gesture complete
                        GameObject.Find("kinectController").GetComponent<MyKinectController>().isMoving = "notMove";
			...
			case Gestures.RaiseLeftHand:
				switch(gestureData.state)
				{
					case 0:  // gesture detection
						...
						{
                            GameObject.Find("kinectController").GetComponent<MyKinectController>().isMoving = "moveLeft";
			...
			case Gestures.Psi:
				switch(gestureData.state)
				{
                    ...
                    case 1:  // gesture complete
                        GameObject.Find("kinectController").GetComponent<MyKinectController>().isMoving = "moveJump";
                        //GameObject.Find("kinectController").GetComponent<MyKinectController>().isMoving = "notMove";
						bool isInPose = jointsTracked[rightHandIndex] && jointsTracked[rightShoulderIndex] &&
							(jointsPos[rightHandIndex].y - jointsPos[rightShoulderIndex].y) > 0.1f &&
							jointsTracked[leftHandIndex] && jointsTracked[leftShoulderIndex] &&
			...
			case Gestures.Jump:
				switch(gestureData.state)
				{
                    ...
                    case 1:  // gesture phase 2 = complete
                        ...
                        //else less than 1.3 meter Unity 
                        else
                        {
                            // cancel the gesture
                            GameObject.Find("kinectController").GetComponent<MyKinectController>().isJumping = false;
