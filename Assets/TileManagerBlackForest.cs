...
public class TileManagerBlackForest : MonoBehaviour {

    public static bool isBackForest;
    ...
    void Spawnplatform(int typePlatform)
    {
        ...
        {
            int randomNormalplatform = Random.Range(7,8);
        ...
        else if( typePlatform == 2)
        {
            ...
            GameObject trapFloor = Instantiate(platform[8], new Vector3(
                starterplatform.position.x,
